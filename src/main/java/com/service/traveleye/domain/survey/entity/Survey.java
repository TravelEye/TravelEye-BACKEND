...
//    private float preferCheapTraffic; // (짧은 거리) 걷기 선호 vs 대중교통 선호
    ...
    @Builder
    public Survey( float preferNatureThanCity, float preferNewCity, float preferDetailPlan, float preferTightSchedule, float preferManyPhotos, float preferGoodFood, float preferDayTrip, float preferCheapHotelThanComfort, Member member) {
